...
# Choose X keyboard language
	...
	echo -n "$blue"
	echo "Change X keyboard language..."
	echo -n "$none"
	echo "Possible language keyboard code are en, de, es, fr, cs ... etc "
	echo -n "$blue"
	echo "Which keyboard layout do you want?"
	echo -n "$none"
	read lang
	sed "s/"cs"/"$lang"/" keyboard.conf > 00-keyboard.conf
